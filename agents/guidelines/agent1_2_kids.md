...
- Difficulty is controlled by sentence structure, not word length — prefer plain
  words and simple grammar over short-but-abstract terms.
- Tone: curious and friendly; questions to the reader are okay but use them sparingly.
